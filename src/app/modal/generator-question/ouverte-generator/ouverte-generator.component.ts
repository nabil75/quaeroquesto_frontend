...
@Component({
  selector: 'app-ouverte-generator',
  standalone: true,
  ...
  templateUrl: './ouverte-generator.component.html',
  styleUrl: './ouverte-generator.component.scss'
})
export class OuverteGeneratorComponent {
